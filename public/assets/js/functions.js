$( document ).ready(function() {
  ...
  // 6. Navigation tactile (Swipe)
  function swipeNavigation() {
    var touchStartY = 0;
    var touchEndY = 0;
    var threshold = 30; // Distance minimum pour valider le swipe

    $(document).on('touchstart', function(e) {
      // On ignore le swipe si le menu est ouvert
    ...
    $(document).on('touchend', function(e) {
      ...
      if (Math.abs(distance) > threshold) {
        var $navItems = $('.side-nav li');
        var $current = $('.side-nav li.is-active');
        var currentIndex = $navItems.index($current);
